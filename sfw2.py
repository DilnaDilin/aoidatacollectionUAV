...
# ----------------------------
# Build greedy solution (used for greedy seed)
# ----------------------------
...
# ----------------------------
# Helper: encode (perm,bps) -> continuous vector (inverse mapping)
# ----------------------------
...
# ----------------------------
# SFW main loop (adapted) with greedy seeding
# ----------------------------
def run_sfw(iot_objs, gb_objs, uav_list, pop=POP, max_iters=MAX_ITERS):
    ...
    def eval_cont_vector(x_cont):
        ...
        # store (score,...,uav_copies) and also chrom and assign to return
