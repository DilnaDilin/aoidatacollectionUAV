...
if __name__ == '__main__':
    ...
    t0 = time.time()
    # Run EIPGA
    best_chrom, best_score, best_info, history, best_assign, uav_copies = run_eipga(iot_objs, gb_list, uav_list, Np=EIPGA_POP, Ng=EIPGA_GEN, Nnew=EIPGA_NNEW, seed=SEED, verbose=EIPGA_VERBOSE)
    ...
    # reconstruct best solution paths and print info
    score, peak, avg_aoi, coverage, total_dist, per_uav_finish_times, feas_flags, uav_copies = evaluate_assignment_fitness(best_assign, iot_objs, gb_list, uav_list)
    ...
    # plot
    plot_solution(iot_objs, gb_list, uav_copies, title="EIPGA multi-UAV (range-aware) result")
